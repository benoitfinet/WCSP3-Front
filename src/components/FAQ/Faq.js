const questions = [
  {
    id: 1,
    question: 'COMBIEN DE TEMPS FAUT-IL POUR PRATIQUER LES ACTIVITES ?',
    response:
  ...
  {
    id: 6,
    question: 'LES PERSONNE EN SITUATION DE HANDICAP PEUVENT ELLE PRATIQUER ?',
    response:
  ...
  },
  {
    ...
    response: 'Atout Branches propose une billetterie en ligne avec laquelle vous pouvez réserver et payer vos entrées pour le jour et l’horaire de votre choix. En réservant en ligne.'
  }
];
