...
import logo2 from '../Nav/img/logo2.jpg';
import logo3 from '../Nav/img/logo3.png';

import './Navbar.css';

// eslint-disable-next-line react/prop-types
const Navbar = ({ imgbanner, textbanner }) => {
  ...
  return (
    ...
    <img src={imgbanner} className="banner-home-all-pages" alt=""/>
