...
class Tresors extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <h1 className="title-framing">{groupes.length !== 0 && groupes[5].title}</h1>
        <div className="trait_et_rond">
          <div className="trait"></div>
          <div className="rond_bleu"></div>
        </div>
        <div className="block-img-para">
          <img alt="photo" className="photoactivite" src={groupes.length !== 0 && groupes[5].image}></img>
          <div className="block-text-button-gpes">
            <p className="textactivites">{groupes.length !== 0 && groupes[5].text}</p>
